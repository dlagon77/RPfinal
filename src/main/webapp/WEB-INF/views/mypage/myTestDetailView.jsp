			...
			<div class="col-md-9">
				...
				<div class="row margin-bottom-20">
					<div class="col-md-6 col-md-offset-0">
						<input class="form-control" type="text"
							value="${mypassign.test_title}" readonly>
					</div>
				</div>
				...
				<label>제출날짜 <span class="color-red">*</span>
					...
					<div class="row margin-bottom-20">
						<div class="col-md-6 col-md-offset-0">
							<input class="form-control" type="text"
								value="${mypassign.test_date }" readonly>
						</div>
					</div>
				<label>첨부파일 <span class="color-red">*</span>
					...
					<div class="row margin-bottom-20">
						...
						<%-- 	<input class="form-control" type="text"
								value="${mypassign.test_date }" readonly> --%>
									<c:if test="${!empty mypassign.test_orfile }">
								<c:url var="assdownfile" value="assdownfile.do">
									<c:param name="rfile" value="${mypassign.test_refile }" />
									<c:param name="ofile" value="${mypassign.test_orfile }" />
								</c:url>
								<a href="${assdownfile }">${mypassign.test_orfile }</a>
								</c:if>
								<c:if test="${empty mypassign.test_orfile }">
								첨부파일 없음
							</c:if> 
