...
<c:import url="../header.jsp" />
	<div class="wrap">
	    ...
	    <div class="container" style="padding : 30px;">
 	   		<h2 style="font-weight:700" align="center">Tip 게시글작성</h2>
       	 	<form method="post" action="tbInsert.do">
			  <div class="form-group">
                 <label>글쓴이</label>
              	 <input type="text" readonly value="${ sessionScope.loginUser.mem_name }" class="form-control">
                 <input type="hidden" name="q_writer" readonly value="${ sessionScope.loginUser.mem_no}" class="form-control">
          	  </div> 	          	 
          	  <div class="form-group">
           		 <label>제목</label>
          	  ...
          	  <div class="form-group">
            	 ...
            	 <textarea name="q_content" class="form-control" rows="5" placeholder="내용을 입력하세요." required></textarea>
           		...
           		<a href='tblist.do' class="btn btn-warning" style="float:right;"><i class="xi-close-min xi-x"></i>&nbsp;취소</a>  
        	</form>
    </div>
</body>
</html>